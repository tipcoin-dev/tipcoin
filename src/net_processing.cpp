...
// TODO-TIP: revert 2.5 * 60; // 2.5 minutes
static constexpr int64_t STALE_CHECK_INTERVAL = 3600 * 24 * 24 * 365;
...
// TODO-TIP: revert 30 * 24 * 60 * 60
static constexpr int STALE_RELAY_AGE_LIMIT = 3600 * 24 * 24 * 365;
