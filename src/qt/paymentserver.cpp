...
const char* BIP71_MIMETYPE_PAYMENT = "application/tipcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/tipcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/tipcoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start tipcoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("tipcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'tipcoin://' is not a valid URI. Use 'tipcoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Tipcoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
