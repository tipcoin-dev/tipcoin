...
A number of changes to the way Monacoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mTip per kB (0.00001 TIP). This is to prepare for dropping the minimum transaction fee to 0.1 mTip per kB (0.0001 TIP) in the next release.
