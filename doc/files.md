...
* monacoin.conf: contains configuration settings for tipcoind or monacoin-qt
* tipcoind.pid: stores the process id of tipcoind while running
...
* debug.log: contains debug information and general logging generated by tipcoind or monacoin-qt
