...
It is possible to run Monacoin Core as a Tor hidden service, and connect to such services.
...
## 2. Run a Monacoin Core hidden server
...
your monacoind's P2P listen port (9469 by default).
...
and open port 9469 on your firewall (or use -upnp).
...
- Do not add anything but Monacoin Core ports to the hidden service created in section 2.
