# Support for Output Descriptors in Tipcoin Core

Since Tipcoin Core v0.17, there is support for Output Descriptors in the
...
on Tipcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Tipcoin Core wallets, a convenience function `combo` is
