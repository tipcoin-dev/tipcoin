...
- [Development guidelines](#development-guidelines)
    - [General Tipcoin Core](#general-monacoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
([`valgrind.supp`](https://github.com/tipcoin-dev/tipcoin/blob/master/contrib/valgrind.supp))
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9469.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9420 for connections and services them.
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:tipcoin-dev/tipcoin.git
