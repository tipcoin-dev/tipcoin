...
"""Verify that starting tipcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tipcoin with -h for help text")
        ...
        self.log.info("Start tipcoin with -version for version information")
        ...
        self.log.info("Start tipcoind with -fakearg to make sure it does not start")
